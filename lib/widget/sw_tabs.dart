...
class _IndicatorPainter extends CustomPainter {
  ...
  final SWTabBarIndicatorSize indicatorSize;
  ...
  Rect indicatorRect(Size tabBarSize, int tabIndex) {
    ...
    if (indicatorSize == SWTabBarIndicatorSize.label) {
...
typedef TapIntercept = bool Function(int index);
...
class SWTabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  final TapIntercept tapIntercept;
...
class _TabBarState extends State<SWTabBar> {
  ...
  @override
  void didUpdateWidget(SWTabBar oldWidget) {
...
/// ancestor.
class SWTabBarView extends StatefulWidget {
...
class _TabBarViewState extends State<SWTabBarView> {
  ...
  @override
  void didUpdateWidget(SWTabBarView oldWidget) {
    super.didUpdateWidget(oldWidget);
    if (widget.controller != oldWidget.controller)
      _updateTabController();
  ...
  Future<void> _warpToCurrentIndex() async {
    ...
    //await _pageController.animateToPage(_currentIndex, duration: kTabScrollDuration, curve: Curves.ease);//全屏K线数据加载切换存在bug
