...
///
/// See also:
///  * [SWCommonTabBar], which displays a row of tabs.
///  * [SWCommonTabBarView], which displays a widget for the currently selected tab.
///  * [SWCommonTabBar.indicator], which defines the appearance of the selected tab
///    indicator relative to the tab's bounds.
enum SWCommonTabBarIndicatorSize {
  ...
  ///
  /// This value is used to align the tab's label, typically a [SWCommonTab]
  /// widget's text or icon, with the selected tab indicator.
  label,
}

/// A material design [SWCommonTabBar] tab. If both [icon] and [text] are
...
///  * [SWCommonTabBar], which displays a row of tabs.
///  * [SWCommonTabBarView], which displays a widget for the currently selected tab.
///  * [TabController], which coordinates tab selection between a [SWCommonTabBar] and a [SWCommonTabBarView].
///  * <https://material.google.com/components/tabs.html>
class SWCommonTab extends StatelessWidget {
  /// Creates a material design [SWCommonTabBar] tab. At least one of [text], [icon],
...
class _IndicatorPainter extends CustomPainter {
  ...
  final SWCommonTabBarIndicatorSize indicatorSize;
  ...
  Rect indicatorRect(Size tabBarSize, int tabIndex) {
    ...
    if (indicatorSize == SWCommonTabBarIndicatorSize.label) {
...
/// conjunction with a [SWCommonTabBarView].
///
...
/// See also:
///
///  * [SWCommonTabBarView], which displays page views that correspond to each tab.
class SWCommonTabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// Typically a list of two or more [SWCommonTab] widgets.
  ///
  ...
  /// and the entire [SWCommonTabBar] is scrollable. Otherwise each tab gets an equal
  ...
  /// the indicator with the tab's text for [SWCommonTab] widgets and all but the
  /// shortest [SWCommonTab.text] values.
  ///
  ...
  /// is [SWCommonTabBarIndicatorSize.tab] the tab's bounds are as wide as the space
  /// occupied by the tab in the tab bar. If [indicatorSize] is
  /// [SWCommonTabBarIndicatorSize.label] then the tab's bounds are only as wide as
  ...
  /// tab's overall bounds if [indicatorSize] is [SWCommonTabBarIndicatorSize.tab]
  /// (the default) or relative to the bounds of the tab's widget if
  /// [indicatorSize] is [SWCommonTabBarIndicatorSize.label].
  ///
  ...
  Size get preferredSize {
    for (Widget item in tabs) {
      if (item is SWCommonTab) {
        final SWCommonTab tab = item;
...
class _TabBarState extends State<SWCommonTabBar> {
  ...
  void _initTextPainterList() {
    final bool isOnlyTabText = widget.tabs
        .map<bool>((Widget tab) =>
            tab is SWCommonTab && tab.icon == null && tab.child == null)
        .toList()
    ...
    if (isOnlyTabText) {
      ...
      _textPainters = widget.tabs.map<TextPainter>((Widget tab) {
        return TextPainter(
          ...
          text: TextSpan(
            text: tab is SWCommonTab ? tab.text ?? '' : '',
            style: defalutStyle,
          ),
        );
      }).toList();
  ...
  @override
  void didUpdateWidget(SWCommonTabBar oldWidget) {
...
/// selected tab. Typically used in conjunction with a [SWCommonTabBar].
///
/// If a [TabController] is not provided, then there must be a [DefaultTabController]
/// ancestor.
class SWCommonTabBarView extends StatefulWidget {
  /// Creates a page view with one child per tab.
  ///
  /// The length of [children] must be the same as the [controller]'s length.
  const SWCommonTabBarView({
    Key key,
...
class _TabBarViewState extends State<SWCommonTabBarView> {
  TabController _controller;
  ...
  @override
  void didUpdateWidget(SWCommonTabBarView oldWidget) {
    super.didUpdateWidget(oldWidget);
...
///
/// Used by [SWCommonTabPageSelector] to indicate the selected page.
class SWCommonTabPageSelectorIndicator extends StatelessWidget {
  /// Creates an indicator used by [SWCommonTabPageSelector].
  ///
  /// The [backgroundColor], [borderColor], and [size] parameters must not be null.
  const SWCommonTabPageSelectorIndicator({
    Key key,
...
/// tab's indicator is highlighted. Often used in conjunction with a [SWCommonTabBarView].
///
/// If a [TabController] is not provided, then there must be a [DefaultTabController]
/// ancestor.
class SWCommonTabPageSelector extends StatelessWidget {
  /// Creates a compact widget that indicates which tab has been selected.
  const SWCommonTabPageSelector({
    Key key,
    this.controller,
  ...
  Widget _buildTabIndicator(
    ...
    return SWCommonTabPageSelectorIndicator(
